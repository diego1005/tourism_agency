module.exports = (sequelize, DataTypes) => {
  ...
  individualContract.associate = (models) => {
    individualContract.hasOne(models.Contract, {
      as: 'ind_contract',
      foreignKey: 'id_ind_contract'
    });
    /* individualContract.belongsTo(models.User, {
      as: 'user', //relationship name
      foreignKey: 'id_user'
    }); */
    individualContract.hasMany(models.Fee, {
      as: 'fees',
      foreignKey: 'id_fee'
    });
    individualContract.belongsTo(models.StateContract, {
      as: 'state_individual_contracts',
      foreignKey: 'id_state_individual_contract'
    });
    individualContract.belongsTo(models.GeneralContract, {
      as: 'general_contract',
      foreignKey: 'id_general_contract'
    });
    individualContract.belongsTo(models.PaymentMethod, {
